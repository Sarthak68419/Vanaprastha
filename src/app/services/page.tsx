            ...
            <section className="services-section">
                ...
                <div className="services-grid">
                    <div className="service-card">
                        ...
                        <p>
                            We will arrange like: Monthly regular health
                            check-ups like BP, Diabetes, Thyroid etc.
                        </p>
                    </div>
                    ...
                    <div className="service-card">
                        ...
                        <p>
                            If patient requires any hospital visit, we will
                            arrange appointments with your doctor at your
                            convenient time, and we accompany & support as your
                            son or daughter till back home.
                        </p>
                    </div>
                    ...
                    <div className="service-card">
                        ...
                        <h3>Care Taker</h3>
                        <p>
                            If necessary, we arrange care takers for your loved
                            one. In case of absence, we provide suitable
                            replacements.
                        </p>
                    </div>
                    ...
                    <div className="service-card">
                        ...
                        <p>
                            We arrange medicines, groceries, and even
                            celebrations of birthdays, anniversaries, and
                            gatherings with photo & video updates.
                        </p>
                    </div>
                    ...
                    <div className="service-card">
                        ...
                        <h3>Payments</h3>
                        <p>
                            We will arrange monthly bill payments like water,
                            electricity, phone, and any banking requirements.
                        </p>
                    </div>
                    ...
                    <div className="service-card">
                        ...
                        <p>
                            If necessary, we provide end-to-end funeral services
